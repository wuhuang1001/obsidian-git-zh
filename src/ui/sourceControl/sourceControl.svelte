<script lang="ts">
    ...
    import { SOURCE_CONTROL } from "src/lang/zh-CN";
...
<main data-type={SOURCE_CONTROL_VIEW_CONFIG.type} class="git-view">
    <div class="nav-header">
        <div class="nav-buttons-container">
            <div
                ...
                aria-label={SOURCE_CONTROL.COMMIT_AND_SYNC}
                bind:this={buttons[0]}
            ...
            <div
                ...
                data-icon="check"
                class="clickable-icon nav-action-button"
                aria-label={SOURCE_CONTROL.COMMIT}
                bind:this={buttons[1]}
                onclick={commit}
            ></div>
            <div
                ...
                aria-label={SOURCE_CONTROL.STAGE_ALL}
                bind:this={buttons[2]}
                onclick={stageAll}
            ></div>
            <div
                ...
                aria-label={SOURCE_CONTROL.UNSTAGE_ALL}
                bind:this={buttons[3]}
                onclick={unstageAll}
            ></div>
            <div
                ...
                class="clickable-icon nav-action-button"
                data-icon="upload"
                aria-label={SOURCE_CONTROL.PUSH}
                bind:this={buttons[4]}
                onclick={push}
            ></div>
            <div
                ...
                class="clickable-icon nav-action-button"
                data-icon="download"
                aria-label={SOURCE_CONTROL.PULL}
                bind:this={buttons[5]}
                onclick={pull}
            ></div>
            <div
                id="layoutChange"
                class="clickable-icon nav-action-button"
                aria-label={SOURCE_CONTROL.CHANGE_LAYOUT}
            ...
            <div
                ...
                aria-label={SOURCE_CONTROL.REFRESH}
                bind:this={buttons[7]}
    ...
    <div class="git-commit-msg">
        <textarea
            ...
            spellcheck="true"
            placeholder={SOURCE_CONTROL.COMMIT_MESSAGE}
        ...
        {#if commitMessage}
            <div
                ...
                aria-label={SOURCE_CONTROL.CLEAR}
            ></div>
        {/if}
    </div>
            ...
            <div class="tree-item nav-folder mod-root">
                    ...
                    >
                        ...
                        <div class="git-tools">
                            <div class="buttons">
                                <div
                                    data-icon="minus"
                                    aria-label={SOURCE_CONTROL.UNSTAGE}
                                    bind:this={buttons[8]}
                                    onclick={unstageAll}
                ...
                >
                    ...
                    >
                        ...
                        <div class="tree-item-inner nav-folder-title-content">
                            {SOURCE_CONTROL.CHANGES}
                        </div>
                        <div class="git-tools">
                            <div class="buttons">
                                <div
                                    data-icon="undo"
                                    aria-label={SOURCE_CONTROL.DISCARD}
                                    onclick={discard}
                                    class="clickable-icon"
                                >
                                    <svg
                                ...
                                <div
                                    data-icon="plus"
                                    aria-label={SOURCE_CONTROL.STAGE}
                                    bind:this={buttons[9]}
                                    onclick={stageAll}
                                    class="clickable-icon"
                                >
                ...
                {#if lastPulledFiles.length > 0 && lastPulledFilesHierarchy}
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                {SOURCE_CONTROL.RECENTLY_PULLED_FILES}
                            </div>
